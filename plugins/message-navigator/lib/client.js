...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".mn-item{box-sizing:border-box;position:absolute;left:4px;width:24px;height:24px;margin:0;padding:0;border:1px solid transparent;background:transparent;display:flex;align-items:center;justify-content:center;gap:3px;cursor:pointer;color:inherit;border-radius:12px}",
      ".mn-itemSteering:not(.mn-itemActive){left:7px}",
      ".mn-dot{box-sizing:border-box;width:5px;height:5px;border-radius:50%;background:var(--dsw-alias-label-tertiary);transition:transform .16s ease,background-color .16s ease}",
      ...
      ".mn-itemActive{left:1px;width:28px;border-color:transparent;background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}",

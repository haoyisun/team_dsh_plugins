...
<svg width="256" height="256" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="10%" y1="0%" x2="90%" y2="100%">
      ...
      <stop offset="100%" stop-color="#243BA7"/>
    </linearGradient>
    <filter id="shadow" x="-20%" y="-20%" width="140%" height="140%">
      <feDropShadow dx="0" dy="8" stdDeviation="12" flood-color="#000000" flood-opacity="0.35"/>
    </filter>
  </defs>
  <!-- Background Squircle (Windows 11 style) -->
  <rect x="16" y="16" width="224" height="224" rx="52" fill="url(#bg)"/>
  <!-- Subtle inner border for 3D glassy effect -->
  <rect x="16" y="16" width="224" height="224" rx="52" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-opacity="0.2"/>
  
  <!-- DeepSeek Fish Logo -->
  <g transform="translate(58.5, 77) scale(6)" filter="url(#shadow)">
...
async function build() {
  ...
  console.log('Built high-resolution Windows app icons using SVG & Sharp.');
}
